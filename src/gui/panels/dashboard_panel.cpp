...
QFrame* DashboardPanel::createInfoCard(const QString& title, const QString& value, const QString& detail)
{
    ...
    if (title == "CPU") valueLbl->setAccessibleName("dash_cpu_model");
    else if (title == "GPU") valueLbl->setAccessibleName("dash_gpu_model");
    else if (title == "RAM") valueLbl->setAccessibleName("dash_ram_value");
    else if (title == "OS") valueLbl->setAccessibleName("dash_os_name");
